    ...
    <MainLayout>
      <Head>
        ...
        <meta
          name="description"
          content="
            Éstos términos y condiciones describen las reglas y regulaciones
            parael uso del sitio web de Bibblis.
          "
        />
      </Head>
      <h1>Términos y condiciones</h1>
      <p>¡Bienvenido a Bibblis.com!</p>
      <p>
        Estos términos y condiciones describen las reglas y regulaciones para
        el uso del sitio web de Bibblis, ubicado en
        {' '}<Link href="/">https://bibblis.com</Link>.
      </p>
      <p>
      ...
      <p>
        ...
        opcionales. Hay algunas cookies obligatorias que son necesarias para el
      ...
      <p>
        ...
        bibblis.com. Todos los derechos de propiedad intelectual son
        reservados. Puedes acceder desde bibblis.com para tu uso personal
      ...
      <ul>
        <li>Copiar o volver a publicar material de bibblis.com</li>
        <li>Vender, alquilar o sublicenciar material de bibblis.com</li>
        <li>Reproducir, duplicar o copiar material de bibblis.com</li>
        <li>Redistribuir contenido de bibblis.com</li>
      </ul>
      ...
      <p>
        ...
        Bibblis no filtra, edita, publica ni revisa los comentarios antes de su
        presencia en el sitio web. Los comentarios no reflejan los puntos de
        vista ni las opiniones de Bibblis, sus agentes y/o afiliados. Los
        comentarios reflejan los puntos de vista y opiniones de la persona que
        publica. En la medida en que lo permitan las leyes aplicables, Bibblis
      ...
      <p>
        Bibblis se reserva el derecho de monitorear todos los comentarios y
      ...
      <p>
        Por la presente, otorgas a Bibblis una licencia no exclusiva para usar,
      ...
      <p>
        ...
        visibilidad del hipervínculo compensa la ausencia de Bibblis; y (d) el
      ...
      <p>
        ...
        un correo electrónico a Bibblis. Incluye tu nombre, el nombre de tu
      ...
      <p>
        ...
        de inmediato todos los enlaces a nuestro sitio web cuando se solicite.
      ...
      <p>
        ...
        esta sección y en otras partes de este descargo de responsabilidad: (a)
        están sujetas al párrafo anterior; y (b) regirá todas las
